...
values ('Andres', 'Eduardo', "", 'Hernandez', 'Castillo', 'Calzada Atanacio Tzul 24 Av. 42-85 zona 12,Ciudad de Guatemala,Guatemala', 'andres@gmail.com', '64581245', '1998-04-21');
insert into personas (nombre1, nombre2, nombre3, apellido1, apellido2, direccion, email, telefono, fecha_nacimiento)
values ('Juan', 'Esteban', "", 'Vasquez', 'Ramirez', '22 Av 34-80 zona 12 Col Santa Eliza,Ciudad de Guatemala,Guatemala', 'juan@gmail.com', '34685946', '2000-09-15');
insert into personas (nombre1, nombre2, nombre3, apellido1, apellido2, direccion, email, telefono, fecha_nacimiento)
values ('Luis', 'Eduardo', "", 'Rodriguez', 'Campos', '14 Av 39-46 zona 8,Ciudad de Guatemala,Guatemala', 'luis@gmail.com', '49567812', '2003-01-12');
insert into personas (nombre1, nombre2, nombre3, apellido1, apellido2, direccion, email, telefono, fecha_nacimiento)
values ('Vicente', 'Francisco', "", 'Martinez', 'Salazar', '21 Av 34-81 zona 12 Col Santa Elisa,Ciudad de Guatemala,Guatemala', 'vicente@gmail.com', '34695168', '1994-12-24');
insert into personas (nombre1, nombre2, nombre3, apellido1, apellido2, direccion, email, telefono, fecha_nacimiento)
values ('David', 'Miguel', "", 'Mazariegos', 'Diaz', '4 Av 1-13 zona 1,Ciudad de Guatemala,Guatemala', 'david@gmail.com', '64951234', '1990-03-10');
insert into personas (nombre1, nombre2, nombre3, apellido1, apellido2, direccion, email, telefono, fecha_nacimiento)
values ('Guillermo', 'Sebastian', "", 'Ramirez', 'Monterroso', '12 Av 22-63 zona 1,Ciudad de Guatemala,Guatemala', 'guillermo@gmail.com', '19468579', '1999-10-29');
insert into personas (nombre1, nombre2, nombre3, apellido1, apellido2, direccion, email, telefono, fecha_nacimiento)
values ('Jose', 'Omar', "", 'Leon', 'Castillo', '7 Av 10-35 zona 9,Ciudad de Guatemala,Guatemala', 'jose@gmail.com', '34916582', '2004-05-16');
insert into personas (nombre1, nombre2, nombre3, apellido1, apellido2, direccion, email, telefono, fecha_nacimiento)
values ('Maria', 'Isabel', "", 'Gallardo', 'Herrera', '13 Av 2-71 zona 2,Ciudad de Guatemala,Guatemala', 'maria@gmail.com', '86495261', '1995-11-03');
insert into personas (nombre1, nombre2, nombre3, apellido1, apellido2, direccion, email, telefono, fecha_nacimiento)
values ('Fernanda', 'Beatriz', "", 'Monterroso', 'Guadalupe', '12 Av 15-30 zona 10,Ciudad de Guatemala,Guatemala', 'fernanda@gmail.com', '48613562', '1976-08-23');
insert into personas (nombre1, nombre2, nombre3, apellido1, apellido2, direccion, email, telefono, fecha_nacimiento)
values ('Lucas', 'Raul', "", 'Enriqez', 'Galvez', '9 Av 3-22 zona 11 Col Roosevelt,Ciudad de Guatemala,Guatemala', 'lucas@gmail.com', '79231648', '1984-09-16');
...
values("Elden Ring",2020/01/04, 100, 1 ,1, 1);
insert into juegos(nombre_juego,fecha_lanzamiento, precio,desarrolladora_id,distribuidora_id ,genero_id)
values("Grand Theft Auto V",2020/01/04, 150, 2 ,2 ,2);
insert into juegos(nombre_juego,fecha_lanzamiento, precio,desarrolladora_id,distribuidora_id ,genero_id)
values("Hades",2020/01/04, 95, 3 ,3, 3);
insert into juegos(nombre_juego,fecha_lanzamiento, precio,desarrolladora_id,distribuidora_id ,genero_id)
values("Doom Eternal",2020/01/04, 60, 4 ,4, 4);
insert into juegos(nombre_juego,fecha_lanzamiento, precio,desarrolladora_id,distribuidora_id ,genero_id)
values("Death Stranding",2020/01/04, 300, 5 ,5, 5);
insert into juegos(nombre_juego,fecha_lanzamiento, precio,desarrolladora_id,distribuidora_id ,genero_id)
values("Valorant",2020/01/04, 0, 6 ,6, 6);
insert into juegos(nombre_juego,fecha_lanzamiento, precio,desarrolladora_id,distribuidora_id ,genero_id)
values("Hollow Knight",2020/01/04, 45, 7 ,7, 7);
insert into juegos(nombre_juego,fecha_lanzamiento, precio,desarrolladora_id,distribuidora_id ,genero_id)
values("Team Fortress 2",2020/01/04, 10, 8 ,8, 8);
insert into juegos(nombre_juego,fecha_lanzamiento, precio,desarrolladora_id,distribuidora_id ,genero_id)
values("Stray",2020/01/04, 100, 9 ,9, 9);
insert into juegos(nombre_juego,fecha_lanzamiento, precio,desarrolladora_id,distribuidora_id ,genero_id)
values("Forza Horizon 5",2020/01/04, 15, 10 ,10, 10);
